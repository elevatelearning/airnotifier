...
sed -i "s/mongouri = \"mongodb:\/\/elevate-learning-mongodb.internal:27017\/\"/mongouri = \"mongodb:\/\/${MONGO_SERVER-elevate-learning-mongodb.internal}:${MONGO_PORT-27017}\"/g" ./config.py
